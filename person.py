...
class Person:
    ...
    def calc(self) -> float:
        dar_amad_paye = self.calc_income()
        hazine_zendegi = self.calc_life_cost()
        dar_amad_tadil = self.do_level(dar_amad_paye)
        return dar_amad_tadil - hazine_zendegi
